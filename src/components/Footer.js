          ...
          <div className="side1">
            <div className="row">
              <div className="col-md-3">
                <h1 className="logo">NexGenSoftware</h1>
          ...
          <div className="side2">
            <div className="row">
              <div className="col-md-3">
                ...
                <ul>
                  <li>
                    <Link to="#" >support@NexGenSoftware.com</Link>
                  </li>
                  <li>
                    <Link to="#" > Banashankari #1522</Link>
                  </li>
                  <li>
              ...
              <div className="col-md-3">
                ...
                <ul>
                  <li>
                    <a target="_blank" rel="noreferrer" href="https://github.com/AshishVajpayee" > Github</a>
                  </li>
                  <li>
                    <a target="_blank" rel="noreferrer" href="https://twitter.com/AshishVajpayee6" > Twitter</a>
                  </li>
                  <li>
